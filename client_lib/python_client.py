...
#query_proxy('http://127.0.0.1:8000/query' ,json.loads('{"action": "stocks", "input": {"stock_symbol": "TWTR"}, "output": {"Last Trade Price": "float"}}'))
query(json.loads('{"action": "stocks", "input": {"stock_symbol": "TWTR"}, "output": {"Volume": "float"}}'))
